...
import { playThemeWhileVisible } from './screensaverAudio'
...
export function Screensaver({ onDismiss }) {
  ...
  // Play the screensaver theme while active AND this tab is selected; stop on
  // dismiss/unmount. Skipped entirely if the page already has audio
  // (Spotify/SoundCloud/a video) so we never talk over what the user is
  // listening to.
  useEffect(() => playThemeWhileVisible(), [])
